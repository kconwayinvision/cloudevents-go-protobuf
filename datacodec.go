...
// Decode converts an encoded protobuf message back into the message type (out).
// The message must be type/wire compatible with whatever was given to Encode.
// This method will assume that the encoded value was encoded by this package
...
// Encode a protobuf message to bytes. This implementations wraps the given
...
// information. The Decode method provided by this package does the inverse
